# Working by Forking
Navigate to the GitHub page and click the "Fork" button. It's as simple as this. Once you get it right, you can use your favorite git client to clone your repo or just head straight to the command line:

## Clone your fork to your local machine
```
git clone git@github.com:USERNAME/team-maker.git
```
...
```
git remote add upstream https://github.com/veerreshr/team-maker.git
``` 
...
```
git branch feature/username/17
```

## Switch to your new branch
```
git checkout feature/username/17
```
Now, its time for your treasure hunt.
